        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Cart Item History</h3>
                    <SplitButton
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Completed Date</label><p className="m-0 ml-3" ><Calendar id="completedDate" value={new Date(_entity?.completedDate)} disabled={true} hourFormat="12"   /></p></div>
