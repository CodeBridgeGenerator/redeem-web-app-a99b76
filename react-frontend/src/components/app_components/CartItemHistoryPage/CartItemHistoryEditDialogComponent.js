...
completedDate: _entity?.completedDate,
    ...
    return (
        <Dialog header="Edit Cart Item History" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="voucherId" className="w-full mb-3 p-inputtext-sm" value={_entity?.voucherId} onChange={(e) => setValByKey("voucherId", e.target.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="completedDate" value={_entity?.completedDate ? new Date(_entity?.completedDate) : null} onChange={ (e) => setValByKey("completedDate", e.value)} showTime hourFormat="24"  />
            </span>
            <small className="p-error">
