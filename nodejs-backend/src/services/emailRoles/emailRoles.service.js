const { EmailRoles } = require("./emailRoles.class");
const createModel = require("../../models/emailRoles.model");
const hooks = require("./emailRoles.hooks");
...
module.exports = function (app) {
  ...
  app.use("/emailRoles", new EmailRoles(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("emailRoles");

  // Get the schema of the collections
  app.get("/emailRolesSchema", function (request, response) {
